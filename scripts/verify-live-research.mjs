...
await writeFile('docs/live-outlook-result.json', JSON.stringify({ sourceMode: outlook.research.sourceMode, factors: outlook.research.factors, scenarioFactors: outlook.scenario.factors, comparisonFactors: outlook.comparisonScenario.factors }, null, 2));
